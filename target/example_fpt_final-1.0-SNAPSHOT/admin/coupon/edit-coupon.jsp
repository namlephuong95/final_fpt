...
<%
    ...
    List<CategoryCoupon> categories = (List<CategoryCoupon>) request.getAttribute("categories");
%>
<!DOCTYPE html>
<html>
<head>
    <jsp:include page="/admin/include/header.jsp">
        ...
        <jsp:param name="description" value="Coupon form"/>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="w3-padding w3-margin-bottom">
        ...
        <%}%>
        <form action="/admin/coupon/edit" method="post" class="w3-container w3-padding w3-card-4 w3-margin">
            <input style="display: none" class="w3-input" type="number" name="id" value="<%=coupon.getId()%>">
            <div class="w3-margin">
                <label>Title</label>
